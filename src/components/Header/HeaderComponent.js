...
import { Navbar, NavbarBrand, Jumbotron, Nav, NavbarToggler, NavItem, Collapse, Button, Modal, ModalHeader, ModalBody, Form, FormGroup, Label, Input } from 'reactstrap';
...
class Header extends Component {
    ...
    render() {
        return (
            <>  {/*This is short for <React.Fragment>  */}
                <Navbar dark expand="md">
                    <div className="container">
                        <NavbarToggler onClick={this.toggleNav} /> {/*OR () => {this.toggleNav()}, then we don't need to bind this in constructor */}
                    ...
                    <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <FormGroup>
                                ...
                                innerRef={(input) => this.password = input} />                            </FormGroup>
                            <FormGroup check>
                                <Label check>
